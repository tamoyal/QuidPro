...
@synthesize foursquareVenueDelegate;
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    [self getVenuesForLocation:([[CLLocation alloc] initWithLatitude:42.351944 longitude:-71.055275])];
}
...
- (void)userDidSelectVenue {
    [self dismissViewControllerAnimated:YES
                             completion:^{
                                 [self.foursquareVenueDelegate venueChosen:self.selected];
                                 NSLog(@"Dismissed");
                             }];
}
